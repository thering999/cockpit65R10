            ...
            <div class="card card-success">
              <div class="card-header border-0">
                <div style="cursor: pointer" onclick="hide_card('card_monitor')" class="d-flex justify-content-between">
                  <h2 class="card-title">ตัวชี้วัด Monitoring 2565 : KPIs <?=get_data1sql($conn,"count(*)","tk_kpi65 tk, kpi k","tk.tk_kpi = k.kpi_id")+
                    get_data1sql($conn,"count(*)","tk_kpi_sub ts, tk_kpi65 tk","ts.tk_id = tk.kpi_num")
                    ?> ตัว</h2>
                </div>
              </div>
            ...
            <div class="card card-info">
              <div class="card-header border-0">
                <div style="cursor: pointer" onclick="hide_card('card_PA')" class="d-flex justify-content-between">
                  <h2 class="card-title">ตัวชี้วัด PA 2565 : KPIs <?=get_data1sql($conn,"count(*)","kpi k","(kpi_id between 101000 and 200000) and kpi_status = 1")?> ตัว</h2>
                </div>
              </div>
